...
public class EmployBoardDto {
    ...
    public EmployBoard toEntity() {
        EmployBoard build = EmployBoard.builder()
                .id(id)
                .author(author)
                .title(title)
                .content(content)
    ...
    @Builder
    public EmployBoardDto(Long id, String author, String title, String content, Long fileId, LocalDateTime createdDate, LocalDateTime modifiedDate, String origFilename) {
        this.id = id;
        this.author = author;
        this.title = title;
