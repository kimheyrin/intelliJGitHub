...
public class FreeBoardDto {
    ...
    @Builder
    public FreeBoardDto(Long id, String author, String title, String content, Long fileId, LocalDateTime createdDate, LocalDateTime modifiedDate, String origFilename) {
        this.id = id;
        this.author = author;
        this.title = title;
