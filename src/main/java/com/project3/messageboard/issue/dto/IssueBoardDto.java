...
public class IssueBoardDto {
    ...
    public IssueBoard toEntity() {
        IssueBoard build = IssueBoard.builder()
                .id(id)
                .author(author)
                .title(title)
                .content(content)
    ...
    @Builder
    public IssueBoardDto(Long id, String author, String title, String content, Long fileId, LocalDateTime createdDate, LocalDateTime modifiedDate, String origFilename) {
        this.id = id;
        this.author = author;
        this.title = title;
